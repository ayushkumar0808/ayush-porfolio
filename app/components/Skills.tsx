          ...
          <div className="grid grid-cols-3 gap-3">
            {technicalSkills.map((skill, i) => (
              <motion.div
                ...
                className="hover-wiggle flex flex-col md:flex-row md:items-center gap-1.5 md:gap-2 p-4 rounded-2xl bg-gray-50/70 border border-black/5"
              >
                <span className="text-2xl text-orange-500 shrink-0 mb-1.5 md:mb-0">
                  {skill.icon}
                </span>
                <div className="min-w-0">
                  <p className="font-semibold leading-tight whitespace-nowrap md:text-sm">
                    {skill.name}
                  </p>
                  <p className="text-sm md:text-xs text-gray-400 leading-tight">
